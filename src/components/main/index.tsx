export function Main() {
  return (
    <div className="bg-gradient-to-r from-[#727E6E] from-60% to-[#576153] to-80% w-full h-screen px-12 flex flex-col justify-center gap-4">
      <h1 className="text-4xl font-normal tracking-wide text-start text-[#111A17] w-20 [text-shadow:_0_4px_4px_rgb(0_0_0_/_25%)] md:text-5xl xl:text-6xl xl:w-60">
        Rafael Pavanelli
      </h1>
      <p className=" text-md text-[#111A17] md:text-2xl xl:text-3xl">
