  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <div className="flex justify-evenly items-center mt-8 w-full gap-6 mb-4 md:text-2xl ">
        <Link href={"https://www.linkedin.com/in/rafael-pavanelli-59807a1a4/"} target="blank">
        ...
        <Link href={"https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=rafaelpavanellitbl@gmail.com"} target="blank">
